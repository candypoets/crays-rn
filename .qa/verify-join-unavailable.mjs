...
// relay the app must not consume a manifest, record room access, or project
...
// manifest (when one is running on the host), which is out of scope here.
...
assert(roomLines('[crays-room-manifest]').length === 0, 'app never consumed a room manifest from the unavailable relay');
