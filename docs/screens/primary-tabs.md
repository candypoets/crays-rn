...
Unit tests own exact order, unique automation IDs, icon states, and inset math. The registered primary-tabs device journey proves native tab selection, retained Tonight local view, Back behavior, and that the real room projection remains the same while tabs change.
