...
and capabilities explain why entry is useful; the room definition carries no event
...
now → original context; closed; anchor rotates and revokes the author; relay drops
