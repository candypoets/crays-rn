...
export default function QaSeedRoute() {
  ...
  useEffect(() => { if (!params.nsec || !__DEV__) return; seedQaIdentity(params.nsec).then(() => setReady(true)).catch((cause) => setError(cause instanceof Error ? cause.message : 'QA identity setup failed.')); }, [params.nsec]);
