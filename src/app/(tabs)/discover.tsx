...
export default function DiscoverRoute() {
  ...
  const duplicatesPrimaryManifest = transportRelay === DEV_TEST_RELAY_URL && roomId === DEV_TEST_ROOM_ID;
  const testRoom = useRoomManifest(__DEV__ && !duplicatesPrimaryManifest ? DEV_TEST_RELAY_URL : undefined, DEV_TEST_ROOM_ID);
