...
Scope: Tonight / Inside, including People, Menu, Feed, live order urgency, quiet-presence truth, and explicit leave; Operate mode.
...
Direction: inherit the approved Night Playlist Inside frame. People leads by default; a yellow ready-order strip and white quiet-presence strip set the tempo before content. The memorable moment is seeing room, privacy, urgency, and the chosen people roster without searching another tab.
